    ...
    return (
        <React.Fragment>
            ...
            <div>
                ...
                <Text>
                    Теперь можно смело доверять своей интуиции и&nbsp;рассылать подарки всем родным и&nbsp;близким с&nbsp;уверенностью! А&nbsp;заботу о&nbsp;качественной доставке Boxberry не&nbsp;только возьмет на&nbsp;себя, но&nbsp;и&nbsp;предоставит скидку в&nbsp;30% по&nbsp;промокоду &laquo;ДРУЗЬЯ&raquo;
                </Text>
            </div>
        </React.Fragment>
    )
