...
const FirstPopup = () => {
    return <Text theme='white'>
        Поздравляем!
        <br />
        Вы собрали полную линию верных ответов и стали одним из 30ти бинго-победителей. Забрать специальный приз можно во флагманском магазине «Нижний 800» по адресу Большая Покровская ул., 8 с 10:00 по 22:00, просто назвав секретную фразу «Я знаю новых героев Нижнего!».
    </Text>
};
