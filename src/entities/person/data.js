const data = [
    {
    ...
    },
     {
        ...
        answers: [
            ...
            'Русский писатель, этнограф и лексикограф, собиратель фольклора, военный врач, автор сборника «Пословицы русского народа»  и «Толкового словаря живого великорусского языка»'
        ],
        rightAnswer: 1,
        onlyDesktop: true,
    ...
    },
    {
        ...
        answers: [
            ...
            'Нижегородский фотограф, автор знаменитого Волжского цикла - серии снимков о культуре и быте народов Поволжья. Снимки из этого цикла используются в большинстве научных изданий по истории региона и России XIX века',
    ...
    },
    {
        ...
        answers: [
            ...
            'Музыкант, теоретик искусства. Во время учебы в нижегородской школе Русского музыкального общества в девятилетнем возрасте сам смастерил скрипку. Автор музыки к первой футуристической опере, где в качестве декораций был впервые показан «Черный квадрат» Казимира Малевича'
        ],
        rightAnswer: 0,
    ...
    },
     {
        ...
        answers: [
            'Писатель, автор известного сборника «Дети подземелья»',
    ...
    },
    {
        ...
        answers: [
            ...
            'Нижегородский архитектор-реставратор, курировал восстановление Нижегородского кремля в XX веке'
        ],
        rightAnswer: 0,
        notRight: 'Не верно! Восстановление кремля в XX векекурировал архитектор-реставратор Святослав Агафонов',
    },
    {
        name: 'Михаил Матюшин',
        answers: [
           ...
           'Русский художник, музыкант, теоретик искусства, один из лидеров русского авангарда первой половины XX века. Матюшин написал музыку к первой футуристической опере «Победа над Солнцем», где в качестве декораций был впервые показан «Чёрный квадрат» Малевича',
    ...
    },
    {
        name: 'Бугровы',
        answers: [
           'Династия купцов-старообрядцев, ставшая крупнейшими соле- и хлебоподрядчиками',
           'Династия нижегородских предпринимателей, меценатов и деятелей культуры ',
    ...
    },
    {
        name: 'Пётр Нестеров',
        answers: [
            'Русский военный летчик, штабс-капитан. Основоположник высшего пилотажа, Нестеров, впервые в мире совершил мёртвую петлю',
            'Купец, который в XIX веке прославился своими прогрессивными идеями в организации бизнеса'
        ],
        rightAnswer: 0,
    ...
    },
    {
        ...
        gender: 1,
        answers: [
            'Первый российский и советский модельер, художник театрального костюма, имела звание «Поставщик двора Ея Императорского Величества»',
            'Первая из русских женщин, ставшая врачом             '
        ],
        rightAnswer: 0,
        notRight: 'Ошибка! Вы перепутали Надежду Ламанову с Надеждой Сусловой',
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            'Купец-старообрядец, представитель одной из самых знаменитых среди дореволюционных купеческих фамилий Нижнего Новгорода             '
        ],
        rightAnswer: 0,
    ...
    },
    {
    ...
    },
     {
        ...
        rightAnswer: 0,
        notRight: 'Ошибка! Добролюбов, прежде всего, литературный критик, а «Грозу» написал Островский    ',
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            'Русский композитор, пианист, дирижер, педагог, глава «Могучей кучки», - творческого содружества русских композиторов       '
        ],
        rightAnswer: 1,
